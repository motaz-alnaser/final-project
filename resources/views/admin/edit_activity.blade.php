    ...
    <section class="stats-section">
        <div class="philosophy-container">
            <div class="stat-card centered-form-card">
                <form id="editActivityForm" method="POST" action="{{ route('admin.update_activity', $activity->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px;">
                        <div>
                            <div class="form-group" style="margin-bottom: 25px;">
                                ...
                                <input type="text" id="activityTitle" name="title" value="{{ old('title', $activity->title) }}" required style="width: 100%; padding: 15px; background: var(--carbon-dark); border: 1px solid var(--metal-dark); border-radius: 8px; color: var(--text-primary); font-size: 14px;">
                            </div>
                            ...
                            <div class="form-group" style="margin-bottom: 25px;">
                                ...
                                <input type="text" id="activityLocation" name="location" value="{{ old('location', $activity->location) }}" required style="width: 100%; padding: 15px; background: var(--carbon-dark); border: 1px solid var(--metal-dark); border-radius: 8px; color: var(--text-primary); font-size: 14px;">
                            </div>
                            ...
                            <div class="form-group" style="margin-bottom: 25px;">
                                ...
                                <input type="number" id="activityPrice" name="price" value="{{ old('price', $activity->price) }}" required min="0" step="0.01" style="width: 100%; padding: 15px; background: var(--carbon-dark); border: 1px solid var(--metal-dark); border-radius: 8px; color: var(--text-primary); font-size: 14px;">
                            </div>
                            ...
                            <div class="form-group" style="margin-bottom: 25px;">
                                ...
                                <input type="number" id="activityCapacity" name="max_participants" value="{{ old('max_participants', $activity->max_participants) }}" required min="1" style="width: 100%; padding: 15px; background: var(--carbon-dark); border: 1px solid var(--metal-dark); border-radius: 8px; color: var(--text-primary); font-size: 14px;">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="form-group" style="margin-bottom: 25px;">
                                ...
                                <select id="activityHost" name="host_id" required style="width: 100%; padding: 15px; background: var(--carbon-dark); border: 1px solid var(--metal-dark); border-radius: 8px; color: var(--text-primary); font-size: 14px;">
                                    @foreach($hosts as $host)
                                        <option value="{{ $host->id }}" {{ $host->id == old('host_id', $activity->host_id) ? 'selected' : '' }}>
                                            {{ $host->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group" style="margin-bottom: 25px;">
                                ...
                                <input type="url" id="activityImageUrl" name="image_url" value="{{ old('image_url', $activity->image_url) }}" style="width: 100%; padding: 15px; background: var(--carbon-dark); border: 1px solid var(--metal-dark); border-radius: 8px; color: var(--text-primary); font-size: 14px;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="margin-bottom: 25px;">
                        ...
                        <textarea id="activityDescription" name="description" rows="6" required style="width: 100%; padding: 15px; background: var(--carbon-dark); border: 1px solid var(--metal-dark); border-radius: 8px; color: var(--text-primary); font-size: 14px; resize: vertical;">{{ old('description', $activity->description) }}</textarea>
                    </div>
